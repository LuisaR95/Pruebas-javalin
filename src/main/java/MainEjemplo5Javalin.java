...
public class MainEjemplo5Javalin {
    public static void main(String[] args) {
        ...
        System.out.println("  http://localhost:7070/index.html");
        System.out.println("    GET /api/productos      -Obtener todos");
        System.out.println("    GET /api/productos/{id} -Obtener todos");
        System.out.println("    POST /api/productos     -Obtener todos");
        System.out.println("    PUT /api/productos/{id} -Obtener todos");
        System.out.println("    DELETE /api/productos/{id} -Obtener todos");
